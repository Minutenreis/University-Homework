...
% todo: check that MPI_ANY_TAG is first documented in MPI 4.0 and not already earlier
...
To use this new avenue to expose parallelism, programs can simply encode the source thread and target thread into the tag.
