...
% behandelt nur CPU, keine Acceleratoren
% reminder: Einleiten was MPI ist, was MPI Bibliotheken sind, populäre nennen (MPICH, OpenMP, IntelMPI?), sagen was OpenMP ist und wofür es genutzt wird, Warum man es zusammen tun sollte,
